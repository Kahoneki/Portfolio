...
{
    return (
        <a className={"h-full flex-1 flex items-center justify-center hover:font-bold hover:bg-linkHover hover:text-xl transition-all duration-300 " + ((pathname == href) ? "font-bold" : "")} href={href}>{children}</a>
    )
}
